...
Edit your project `.env` file and replace the placeholders with your actual values.

### Option B: Use the Update Script
1. Edit `scripts/update_stripe_env.sh`
2. Replace the placeholder values with your actual values
3. Run: `bash scripts/update_stripe_env.sh`
