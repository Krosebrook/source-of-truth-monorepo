    ...
    messages: [
      {
        role: "user",
        content:
          "Test FlashFusion Anthropic integration. Respond with: 'FlashFusion + Claude integration successful!'",
      },
    ],
  });
...
async function main() {
  ...
  log(
    "cyan",
    `  Key Format: ${ANTHROPIC_API_KEY.startsWith("sk-ant") ? "Anthropic Key ✅" : "Unknown Format"}`
  );
